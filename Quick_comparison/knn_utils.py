...
def check_pairwise_arrays(X, Y, precomputed=False, dtype=None,force_all_finite="allow-nan"):
    ...
    if Y is X or Y is None:
        ...
        X = validation.check_array(X.reshape(-1, 1), accept_sparse='csr', dtype=dtype,
                        estimator=estimator,force_all_finite=force_all_finite)
        Y = validation.check_array(Y.reshape(-1, 1), accept_sparse='csr', dtype=dtype,
                         estimator=estimator,force_all_finite=force_all_finite)
